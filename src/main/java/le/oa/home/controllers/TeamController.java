...
public class TeamController extends BaseController {
    ...
    @Inject
    public TeamController(TeamUserRepository teamUserRepository, TeamRepository teamRepository) {
    ...
    public Result create(FlashScope flashScope) {
        ...
        teamUser.setOwner(true);
        teamUser.setUser(this.currentUserProvider.get());
